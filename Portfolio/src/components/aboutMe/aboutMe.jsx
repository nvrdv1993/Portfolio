...
import './aboutMe.scss';
import codeLignes from '../../assets/codelignes.jpg';
...
const AboutMe = () => {
  ...
  useEffect(() => {
    ...
    }, 75); // Typing and deleting speed (in milliseconds)
  ...
  return (
    <>
      <div className="banner">
        <img src={codeLignes} alt="Banner" className="banner-image" />
        <h1 className="typewriter-text">
          Je suis,<br /> {displayedLetters}<span className="blinking-cursor">_</span>
        </h1>
      </div>
